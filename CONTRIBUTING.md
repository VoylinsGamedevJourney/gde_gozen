...
1. Go to the [Issues tab](https://codeberg.org/VoylinsGamedevJourney/gde_gozen/issues);
...
1. Go to the [Issues tab](https://codeber.com/gozen/gde_gozen/issues);
1. Click the "New Issue" button;
...
1. **Fork the repo:**
    * [Fork the GDE GoZen project from Codeberg](https://codeberg.org/gozen/gde_gozen/fork) to create your own copy of GDE GoZen to work in;
...
If you want to support GDE GoZen and GoZen (the video editor) financially, you can do so via following pages:
